...
const Carousel = ({
  ...
  useEffect(() => {
    ...
    return () =>
      carouselRef.current.removeEventListener("scroll", updateCurrentPos);
  }, [updateCurrentPos]);
      ...
      <div className={`flex-container carousel-controls ${controlsClass}`}>
        ...
        <div className={`button-wrapper`}>
          <button
            ...
            onClick={prevPage}
            disabled={carouselRef.current ? currentPosPxl <= 25 : true}
            aria-hidden="true"
            tabIndex={-1}
          >
          ...
          <button
            ...
            onClick={nextPage}
            disabled={
              carouselRef.current ? isLastPage(carouselRef.current) : false
            }
            aria-hidden="true"
            tabIndex={-1}
          >
